...
for_parents_glmer <- FE_mother_father_long  %>%
  mutate(mother_change = case_when(Visit_1_Mom == Visit_2_Mom ~ "No change",
                                   TRUE~ "change")) %>%
  mutate(father_change = case_when(Visit_1_Dad == Visit_2_Dad ~ "No change",
                                   TRUE~ "change"))


#Mother change model

mother_change_model<- glmer(as.factor(mother_change) ~ scale(length_between_visits) +(1|anon_baby_id), data = for_parents_glmer, family="binomial")

summary(mother_change_model)

father_change_model<- glmer(as.factor(father_change) ~ scale(length_between_visits) +(1|anon_baby_id), data = for_parents_glmer, family="binomial")

summary(father_change_model)


##### Linear model graphs

figure_y_a <-ggplot(FE_for_anova_graphs, aes( x=age , y=fre_exp, color=caregiver_1_french_use)) +
  geom_smooth(alpha=0.2)+
  theme_bw() +
  ylim(0, 100)+
       theme(axis.text.x = element_text(size=20), axis.text.y = element_text(size=20),axis.title = element_text(size=20), plot.title = element_text(size=20), legend.position = "none")+
...
figure_y_b <-ggplot(FE_for_anova_graphs, aes( x=age , y=fre_exp, color=caregiver_2_french_use)) +
  geom_smooth(alpha=0.2)+
  theme_bw() +
  ylim(0, 100)+
       theme(axis.text.x = element_text(size=20), axis.text.y = element_text(size=20),axis.title = element_text(size=20), plot.title = element_text(size=20), legend.position = "none")+
...
figure_y_c <-ggplot(FE_for_anova_graphs, aes( x=age , y=eng_exp, color=caregiver_1_english_use)) +
  geom_smooth(alpha=0.2)+
  theme_bw() +
  ylim(0, 100)+
       theme(axis.text.x = element_text(size=20), axis.text.y = element_text(size=20),axis.title = element_text(size=20), plot.title = element_text(size=20), legend.position = "none")+
...
figure_y_d <-ggplot(FE_for_anova_graphs, aes( x=age , y=eng_exp, color=caregiver_2_english_use)) +
  geom_smooth(alpha=0.2)+
  theme_bw() +
  ylim(0, 100)+
       theme(axis.text.x = element_text(size=20), axis.text.y = element_text(size=20),axis.title = element_text(size=20), plot.title = element_text(size=20), legend.position = "none")+
...
figure_7_a <-ggplot(her_for_anova_graphs, aes( x=strategy , y=fre_exp, fill = strategy )) +
  stat_summary(geom="bar")+
  stat_summary() +
  ylim(0,100) +
   scale_fill_manual (name = "Family Strategy", values =c(my_orange, my_yellow, my_blue)) +
...
figure_7_b <- ggplot(her_for_anova_graphs, aes( x=strategy , y=eng_exp, fill = strategy )) +
  stat_summary(geom="bar")+
  stat_summary() +
  ylim(0,100) +
   scale_fill_manual (name = "Family Strategy", values =c(my_orange, my_yellow, my_blue)) +
...
figure_7_c <-ggplot(her_for_anova_graphs, aes( x=strategy , y=min_exp, fill = strategy )) +
  stat_summary(geom="bar")+
  stat_summary() +
  ylim(0,100) +
   scale_fill_manual (name = "Family Strategy", values =c(my_orange, my_yellow, my_blue)) +
