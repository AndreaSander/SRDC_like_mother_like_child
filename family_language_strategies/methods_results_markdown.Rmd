...
```
  ...
  We were also interested in weather the mean exposure to the majority languages French and English, and the mean exposure to a minority language changed as a function of which family language strategy was used. In Figure 2 it can be observed that 
