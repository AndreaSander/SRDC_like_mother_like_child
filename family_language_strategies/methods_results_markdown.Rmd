...
age_min <- round(min(final_data$age, na.rm = T), 2)
age_max<- round(max(final_data$age, na.rm = T), 2)
age_mean<- round(mean(final_data$age, na.rm = T), 2)
age_sd<- round(sd(final_data$age, na.rm = T), 2)
