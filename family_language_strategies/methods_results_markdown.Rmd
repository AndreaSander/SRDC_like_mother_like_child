...
figure_3_a <-ggplot(for_anova_graphs, aes( x=age , y=fre_exp, color=strategy, fill = strategy )) +
...
figure_3_b <-ggplot(for_anova_graphs, aes( x=age , y=eng_exp, color=strategy, fill = strategy )) +
  geom_smooth(alpha=0.2)+
  scale_color_manual (name = "Family Strategy", values =c(my_orange, my_yellow, my_blue)) +
  theme_bw() +
  ylim(0, 100)+
...
figure_3_c <-ggplot(for_anova_graphs, aes( x=age , y=min_exp, color=strategy, fill = strategy )) +
  geom_smooth(alpha=0.2)+
  scale_color_manual (name = "Family Strategy", values =c(my_orange, my_yellow, my_blue)) +
  theme_bw() +
  ylim(0, 100)+
...
figure_3_d <-ggplot(for_anova_graphs, aes( x=age , y=exp_l2, color=strategy, fill = strategy )) +
  geom_smooth(alpha=0.2)+
  scale_color_manual (name = "Family Strategy", values =c(my_orange, my_yellow, my_blue)) +
  theme_bw() +
  ylim(0, 50)+
...
long_model<- glmer(as.factor(change_strat) ~ length_between_visits +(1|anon_baby_id), data = for_long_glmer, family="binomial")
