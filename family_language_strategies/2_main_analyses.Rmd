...
t.test(exp_l1~strategy, data = for_t_tests, subset = strategy %in% c("one-language-at-home","one-parent-bilingual"),  mu=0, conf.level = 0.95, paired=F) #statistically different. So One langauge at home is more statistically likely to be associated with a high l1 input

t.test(exp_l1~strategy, data = for_t_tests, subset = strategy %in% c("one-parent-bilingual", "both-parents-bilingual"),  mu=0, conf.level = 0.95, paired=F) #sig difference

t.test(exp_l1~strategy, data = for_t_tests, subset = strategy %in% c("one-parent-bilingual", "one-parent-one-lang-strict"),  mu=0, conf.level = 0.95, paired=F) #sig difference
...
t.test(fre_exp~strategy, data = for_t_tests, subset = strategy %in% c("one-parent-one-lang-flex","one-language-at-home"),  mu=0, conf.level = 0.95, paired=F) #no statistical difference
