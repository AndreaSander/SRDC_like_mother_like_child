...
##  French aoa
hist(her_for_sup$mother_french_aoa)
hist(her_for_sup$father_french_aoa)


## English aoa
hist(her_for_sup$mother_english_aoa)
hist(her_for_sup$father_english_aoa)

## heritage aoa
hist(her_for_sup$mother_heritage_aoa)
hist(her_for_sup$father_heritage_aoa)
...
##### proficiency (accent) by strategy
  ...
  mutate(perc= prop*100)
            ...
            her_heritahe_mother_proficiency <- her_for_sup %>%
   filter(!strategy == "single-parent")%>%
   drop_na(strategy)%>%
