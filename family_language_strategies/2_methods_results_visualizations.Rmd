...
ov2<- plot_models(her_lm_parents_aditive_eng, her_lm_parents_aditive_fre, her_lm_parents_aditive_her, show.values = T, show.p = T, title = "B.Individual Parents' Contributions Model Estimates- Heritage Sample", axis.labels = ov2_labels)+ theme_bw()
