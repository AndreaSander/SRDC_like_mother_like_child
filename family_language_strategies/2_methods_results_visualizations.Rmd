...
figure_2<- figure_2 +
  ...
  theme_bw()+
    annotate("richtext", x=c(1,1,1), y=c(10,1,-5), label=FE_node_counts$count)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(10,1,-5), label=FE_next_node_counts$count)+ #Adding the N at time 2
...
figure_3_a <- ggplot(mom_long_fre_s , aes(x = x, 
  ...
  labs(title= "A. Mothers' change of language use French")+
      annotate("richtext", x=c(1,1,1), y=c(6,-10,-22), label=mom_fre_node_counts$count, size=8)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(6,-10,-22), label=mom_fre_next_node_counts$count, size=8) #Adding the N at time 2
...
figure_3_b <- ggplot(mom_long_eng_s , aes(x = x, 
  ...
  labs(title= "B. Mothers' change of language use English")+
      annotate("richtext", x=c(1,1,1), y=c(4,-12,-22), label=mom_eng_node_counts$count, size=8)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(4,-13,-22), label=mom_eng_next_node_counts$count, size=8) #Adding the N at time 2
...
figure_4_a <- ggplot(dad_long_fre_s , aes(x = x, 
  ...
  labs(title= "A. Fathers' change of language use French")+
      annotate("richtext", x=c(1,1,1), y=c(4,-11,-22), label=dad_fre_node_counts$count, size=8)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(4,-11,-22), label=dad_fre_next_node_counts$count, size=8) #Adding the N at time 2
