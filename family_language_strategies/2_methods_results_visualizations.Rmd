...
figure_3_a <- ggplot(mom_long_fre_s , aes(x = x, 
  ...
  theme_bw()+
  theme(axis.text.x = element_text(size=30),legend.position = "none", plot.title = element_text(size=35), axis.title=element_blank()) +
  labs(title= "A. Mothers' change of language use French")+
      annotate("richtext", x=c(1,1,1), y=c(6,-10,-22), label=mom_fre_node_counts$count, size=10)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(6,-10,-22), label=mom_fre_next_node_counts$count, size=10) #Adding the N at time 2
...
figure_3_b <- ggplot(mom_long_eng_s , aes(x = x, 
  ...
  theme_bw()+
  theme(axis.text.x = element_text(size=30), plot.title = element_text(size=35), axis.title = element_blank(), legend.text = element_text(size=30), legend.title = element_text(size=30))+
  labs(title= "B. Mothers' change of language use English")+
      annotate("richtext", x=c(1,1,1), y=c(5,-11,-21), label=mom_eng_node_counts$count, size=8)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(5,-12,-21), label=mom_eng_next_node_counts$count, size=8) #Adding the N at time 2
...
figure_4_a <- ggplot(dad_long_fre_s , aes(x = x, 
  ...
  labs(title= "A. Fathers' change of language use French")+
      annotate("richtext", x=c(1,1,1), y=c(4,-11,-22), label=dad_fre_node_counts$count, size=10)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(4,-11,-22), label=dad_fre_next_node_counts$count, size=10) #Adding the N at time 2
...
figure_4_b <- ggplot(dad_long_eng_s , aes(x = x, 
  ...
  labs(title= "B. Fathers' change of language use English")+
      annotate("richtext", x=c(1,1,1), y=c(4,-10,-22), label=dad_eng_node_counts$count, size=8)+ #Adding the N at time 1
  annotate("richtext", x=c(2,2,2), y=c(4,-10,-22), label=dad_eng_next_node_counts$count, size=8) #Adding the N at time 2
