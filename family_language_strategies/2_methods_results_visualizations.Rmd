...
figure_8_a <-ggplot(data= for_lms, aes( x=age , y=fre_exp, color=caregiver_1_french_use)) + 
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
       scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
...
figure_8_b <-ggplot(data= for_lms, aes( x=age , y=fre_exp, color=caregiver_2_french_use)) +  
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
      scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
...
figure_8_c <-ggplot(data= for_lms, aes( x=age , y=eng_exp, color=caregiver_1_english_use)) +
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
     scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
...
figure_8_d <-ggplot(data= for_lms, aes( x=age , y=eng_exp, color=caregiver_2_english_use)) +
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
  scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
