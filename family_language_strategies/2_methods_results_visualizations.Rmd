...
performance:: model_performance(anova_model_french)
performance:: model_performance(anova_model_english)
performance:: model_performance(anova_model_heritage)
performance:: model_performance(blc_model)

performance:: check_model(blc_model)
performance:: check_model(anova_model_french)
performance:: check_model(anova_model_english)
...
FE_opol<- FEH %>%
  filter(bilingual_type == "fre-eng") %>%
  filter(strategy=="one-parent-one-lang") %>%
  mutate(parents_lang_use = case_when(l1== "French" & care1_l1 == "regularly" & care1_l2=="never" & care2_l1 =="never" & care2_l2=="regularly"~ "mom__french_dad_english",
                                      l1== "English" & care1_l1 == "regularly" & care1_l2=="never" & care2_l1 =="never" & care2_l2=="regularly"~ "mom__english_dad_french",
                                      l1== "French" & care1_l1 == "never" & care1_l2=="regularly" & care2_l1 =="regularly" & care2_l2=="never"~ "mom__english_dad_french",
                                      l1== "English" & care1_l1 == "never" & care1_l2=="regularly" & care2_l1 =="regularly" & care2_l2=="never"~ "mom__french_dad_english",
                                      
                                      
                                      l1== "French" & care1_l1 =="regularly" & care1_l2 == "sometimes" & care2_l1 =="never" & care2_l2=="regularly"  ~ "mom_flex_dad_eng",
                                      l1== "English" & care1_l1 =="regularly" & care1_l2 == "sometimes" & care2_l1 =="regularly" & care2_l2=="never"  ~ "mom_flex_dad_eng",
                                      l1== "French" & care1_l1 =="sometimes" & care1_l2 == "regularly" & care2_l1 =="never" & care2_l2=="regularly"  ~ "mom_flex_dad_eng",
                                      l1== "English" & care1_l1 =="sometimes" & care1_l2 == "regularly" & care2_l1 =="regularly" & care2_l2=="never"  ~ "mom_flex_dad_eng",
                                      l1== "French" & care1_l1 =="regularly" & care1_l2 == "sometimes" & care2_l1 =="regularly" & care2_l2=="never"~ "mom_flex_dad_fre",
                                      l1== "English" & care1_l1 =="regularly" & care1_l2 == "sometimes" & care2_l1 =="never" & care2_l2=="regularly"~ "mom_flex_dad_fre",
                                      l1== "French" & care1_l1 =="sometimes" & care1_l2 == "regularly" & care2_l1 =="regularly" & care2_l2=="never"  ~ "mom_flex_dad_fre",
                                      l1== "English" & care1_l1 =="sometimes" & care1_l2 == "regularly" & care2_l1 =="never" & care2_l2=="regularly"  ~ "mom_flex_dad_fre",

                                      
                                      l1== "French" & care1_l1 =="never" & care1_l2 == "regularly" & care2_l1 =="regularly" & care2_l2=="sometimes"  ~ "dad_flex_mom_eng",
                                      l1== "English" & care1_l1 =="regularly" & care1_l2 == "never" & care2_l1 =="regularly" & care2_l2=="sometimes"  ~ "dad_flex_mom_eng",
                                      l1== "French" & care1_l1 =="never" & care1_l2 == "regularly" & care2_l1 =="sometimes" & care2_l2=="regularly"  ~ "dad_flex_mom_eng",
                                      l1== "English" & care1_l1 =="regularly" & care1_l2 == "never" & care2_l1 =="sometimes" & care2_l2=="regularly"  ~ "dad_flex_mom_eng",
                                      l1== "French" & care1_l1 =="regularly" & care1_l2 == "never" & care2_l1 =="regularly" & care2_l2=="sometimes"~ "dad_flex_mom_fre",
                                      l1== "English" & care1_l1 =="never" & care1_l2 == "regularly" & care2_l1 =="regularly" & care2_l2=="sometimes"~ "dad_flex_mom_fre",
                                      l1== "French" & care1_l1 =="regularly" & care1_l2 == "never" & care2_l1 =="sometimes" & care2_l2=="regularly"  ~ "dad_flex_mom_fre",
                                      l1== "English" & care1_l1 =="never" & care1_l2 == "regularly" & care2_l1 =="sometimes" & care2_l2=="regularly"  ~ "dad_flex_mom_fre",
...
figure_8_a <-ggplot(data= lm_fre, aes( x=age , y=fre_exp, color=caregiver_1_french_use)) +
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
       scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
...
figure_8_b <-ggplot(data= lm_fre, aes( x=age , y=fre_exp, color=caregiver_2_french_use)) +
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
      scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
...
figure_8_c <-ggplot(data= lm_eng, aes( x=age , y=eng_exp, color=caregiver_1_english_use)) +
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
     scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
...
figure_8_d <-ggplot(data= lm_eng, aes( x=age , y=eng_exp, color=caregiver_2_english_use)) +
  geom_smooth(alpha=0.2, size=2)+
  theme_bw() +
  ylim(0, 1)+
  scale_color_manual(values = c("#75638b","#41ae76", "#dac291"))+
